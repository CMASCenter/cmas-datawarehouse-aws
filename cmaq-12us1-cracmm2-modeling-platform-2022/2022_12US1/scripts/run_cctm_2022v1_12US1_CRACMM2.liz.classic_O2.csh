...
##SBATCH --nodelist=nep[15070205-15070208]
#SBATCH -o cmaq_2022_12US1_cracmm2_two_day_%j.txt
...
#> Set General Parameters for Configuring the Simulation
 set VRSN      = v6.0b1              #> Code Version
 set PROC      = mpi               #> serial or mpi
 set MECH      = cracmm2      #> Mechanism ID
 setenv MECH cracmm2
 set APPL      = 2022_12US1_CRACMM2_classic_O2  #> Application Name (e.g. Gridname)
...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}_O2
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2021-12-22"     #> beginning date (Dec 22, 2021)
 set END_DATE   = "2021-12-22"     #> ending date    (Dec 23, 2021)
...
set EMISpath_pre =  $INPDIR/emis/cracmmv2_20241031/premerged
...
#  set OMIfile   = OMI_1979_to_2019.dat
  ...
  setenv LAYER_FILE $METpath/METCRO3D.12US1.35L.$YYMMDD
  ...
  setenv CMAQ_MASKS $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12NE3_classic.nc #> horizontal grid-dependent ocean file
  ...
  setenv GR_EMIS_002 ${EMISpath_pre}/rwc/${EMISfile}
  ...
  setenv STK_GRPS_003 $IN_PTpath/canmex_point/stack_groups_canmex_point_${STKCASEG}.ncf
  setenv STK_GRPS_004 $IN_PTpath/ptagfire/stack_groups_ptagfire_${YYYYMMDD}_${STKCASEG}.ncf
  setenv STK_GRPS_005 $IN_PTpath/ptfire-wild/stack_groups_ptfire-wild_${YYYYMMDD}_${STKCASEG}.ncf
  ...
  setenv STK_EMIS_003 $IN_PTpath/canmex_point/inln_mole_canmex_point_${mwdss_N}_${STKCASEE}.ncf
  setenv STK_EMIS_004 $IN_PTpath/ptagfire/inln_mole_ptagfire_${YYYYMMDD}_${STKCASEE}.ncf
  setenv STK_EMIS_005 $IN_PTpath/ptfire-wild/inln_mole_ptfire-wild_${YYYYMMDD}_${STKCASEE}.ncf
  ...
  #> In-line lightning NOx options
     ...
     if ( $USE_NLDN == Y ) then
        setenv NLDN_STRIKES ${IN_LTpath}/WWLLNs_12km_60min_${YYYYMMDD}.ioapi
     endif
  ...
  setenv OCEAN_1 $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US1_classic.nc
