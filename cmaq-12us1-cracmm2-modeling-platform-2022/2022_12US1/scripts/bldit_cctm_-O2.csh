...
#> Working directory and Version IDs
 if ( $?ISAM_CCTM ) then
     set VRSN  = v6.0b1_ISAM             #> model configuration ID for CMAQ_ISAM
 else if ( $?DDM3D_CCTM ) then
     set VRSN = v6.0b1_DDM3D             #> model configuration ID for CMAQ_DDM
 else
     set VRSN = v6.0b1                   #> model configuration ID for CMAQ
 endif
