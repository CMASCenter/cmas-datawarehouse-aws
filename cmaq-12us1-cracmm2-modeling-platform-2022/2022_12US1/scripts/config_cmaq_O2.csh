...
#> Critical Folder Locations
 ...
 setenv CMAQ_REPO /proj/ie/proj/CMAS/CMAQ/CMAQv6.0b1_2022/CMAQ_REPO_6.0b1
...
#>  Intel fortran compiler......................................................
    case intel:
       setenv BUILD /work/users/l/i/lizadams/test_classic_libraries_sycamore/LIBRARIES_intel_classic/
	...
	setenv myFSTD "-O2 -fno-strict-aliasing"
        setenv myDBG  "-O0 -g -fpe0 -fno-alias -ftrapuv -traceback"
        setenv myLINK_FLAG ""  #"-qopenmp-simd" openMP not supported w/ CMAQ
        setenv myFFLAGS "-fixed -132"
        setenv myFRFLAGS "-free"
        setenv myCFLAGS "-O2"
        setenv extra_lib "-lm -lzip -lcurl -qopenmp"
...
#> I/O API, netCDF, and MPI libraries
 setenv netcdf_lib "-lnetcdf -lcurl -lhdf5 -lhdf5_hl "  #> -lnetcdff -lnetcdf for netCDF v4.2.0 and later
