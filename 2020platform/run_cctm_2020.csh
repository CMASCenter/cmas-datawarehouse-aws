...
## Sample run script for 2 day benchmark - tested on dogwood.unc.edu
...
#SBATCH -t 4:00:00
#SBATCH -o /proj/ie/proj/CMAS/CMAQ/2020_12US1/CMAQ_v54+/CCTM/scripts/cmaq_%j.txt
#SBATCH --no-requeue
...
# /work/MOD3DEV/hwo/cmaq_testbed/CRACMM1_AirToxScreen_May-01-2023_Parallel/CCTM/scripts/BLD_CCTM_v54_intel21.4/CCTM_v54.exe
...
echo 'before config:'
module list
# from source /work/MOD3DEV/hwo/cmaq_testbed/CRACMM1_AirToxScreen_May-01-2023_Parallel/config_cmaq.csh intel 21.4
# should be:
  # 1) modules                    5) netcdf-4.8.1/intel-21
  # 2) mariadb/10.6.3             6) pnetcdf-1.9.0/intel-18.0
  # 3) intel/21.4                 7) forge/21.1.2
  # 4) intelmpi/21.4

  #module load mariadb/10.6.3
  #module load intel/21.4
  #module load intelmpi/21.4
  #module load netcdf-4.8.1/intel-21
  #module load pnetcdf-1.9.0/intel-18.0
  #module load forge/21.1.2
...
#setenv CMAQ_HOME /work/MOD3DEV/hwo/cmaq_testbed/CRACMM1_AirToxScreen_May-01-2023_Parallel/CCTM/scripts/BLD_CCTM_v54_intel21.4
setenv CMAQ_HOME /proj/ie/proj/CMAS/CMAQ/2020_12US1/CMAQ_v54+/
setenv CMAQ_DATA /proj/ie/proj/CMAS/CMAQ/2020_12US1/CMAQ_v54+/data


#set compilerString = intel21.4
...
#> Set General Parameters for Configuring the Simulation
 ...
 set MECH      = cb6r5hap_ae7_aq      #> Mechanism ID
...
# set APPL  = 2032gg_18j_cb6r3_ae7_aq_nvpoa.v532_m3dry.12US2_35
# set APPL  = 2032gg_18j_cb6r3_ae7_aq_nvpoa_50ptegunoxso2.v532_m3dry.12US2_35
# set APPL  = 2032gg_18j_cb6r3_ae7_aq_nvpoa_50ptegunoxso2_50ptnonnoxso2.v532_m3dry.12US2_35
# set APPL  = 2032gg_18j_cb6r3_ae7_aq_nvpoa_50rwc.v532_m3dry.12US2_35
# set APPL  = 2018gg_18j_cb6r5_ae7_aq_nvpoa.v54_stage.12US2_35
set APPL = 2020ha2_MP_cb6r5hap_ae7.v54.12US1_35  # this is nvpoa run. for short name, we do not put nvpoa in file name.
...
# set BLD = /work/MOD3DEV/hwo/cmaq_testbed/CRACMM1_AirToxScreen_May-01-2023_Parallel/CCTM/scripts/BLD_CCTM_v54_intel21.4
...
#> Set Working, Input, and Output Directories
 setenv WORKDIR ${CMAQ_HOME}/scripts                 #> Working Directory. Where the runscript is.
...
# =====================================================================
 ...
 set firstday  = "2019-12-22"

#> Set Start and End Days for looping
set START_DATE = "2019-12-22"    #> beginning date
#set START_DATE = "2018-01-26"    #> beginning date
#set START_DATE = "2018-06-09"    #> beginning date
#set START_DATE = "2018-11-23"    #> beginning date
set END_DATE   = "2019-12-23"    #> end date
...
setenv GRIDDESC ${CMAQ_DATA}/GRIDDESC_css   #> grid description file
...
# does not seem to be used in v5.4
...
# =========================== begin major v5.4 script insert
...
setenv CTM_PHOTDIAG Y        #> agree with previous 5.32 run
...
setenv OPTICS_MIE_CALC  F
setenv CORESHELL_OPTICS F
...
# =========================== end major v5.4 script insert

# keep EMIS_SYM_DATE for default
...
set ICpath    = ${CMAQ_DATA}/icbc_2020_tox_addhr
set BCpath    = ${CMAQ_DATA}/icbc_2020_tox_addhr
...
set IN_LTpath = ${CMAQ_DATA}/nldn
#set IN_LTpath = /work/MOD3APP/ezv/2020_12US1/nldn
#set IN_LTpath = /work/MOD3EVAL/dkj/LTNG/NLDN_12US/2020        #> lightning NOx input directory
...
set LUpath = ${CMAQ_DATA}/surface
#set LUpath    = /work/MOD3APP/ezv/2020_12US1/surface
#set LUpath    = /work/MOD3DATA/2018_12US1/surface # set later            #> BELD landuse data for windblown dust model
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE GCv14_CB6_AE7.20191201_0000z.12US1.ICON_hap_benap.timind
...
#/work/ROMO/users/bkx/cmaq/o11615/task1/2022/omi/OMI_1979_to_2022.dat from bkx
#setenv OMI /work/MOD3DEV/hwo/cmaq_testbed/Expanded_formatting_in_create_omi_Dec-10-2021_Parallel/PREP/create_omi/scripts/output/omi_intel18.0_2020_17X17/omi_cmaq_2020.dat
  setenv OMI $INPDIR/omi/omi_cmaq_2020.dat

  #> Boundary conditions
  set BCFILE = GCv14_CB6_AE7.$YYYYMMDD"_0000z".12US1.BCON_hap_benap.nc
...
# /asm/ROMO/met/MCIP/WRFv4.1.1_12US1_2020_35aL_lucor/v5.3.3
  set METpath = ${CMAQ_DATA}/mcip/WRFv4.1.1_12US1_2020_35aL_lucor/v5.3.3
  set sfx = .12US1.35L.$YYMMDD
...
# EMISSCTRL_NML does not seem to be in v5.4
...
#  setenv EMISSCTRL_NML $base0/ref/EmissCtrl_cb6r3_ae7_aq_nvpoa_50ptegunoxso2.nml
#  setenv EMISSCTRL_NML $base0/ref/EmissCtrl_cb6r3_ae7_aq_nvpoa_50ptegunoxso2_50ptnonnoxso2.nml
#  setenv EMISSCTRL_NML $base0/ref/EmissCtrl_cb6r3_ae7_aq_nvpoa_50rwc.nml

# the following seems to replace v5.3 EMISSCTRL_NML 
# ============================================== begin major v5.4 script insert
  #> Control Files
  #>
  #> IMPORTANT NOTE
...
#  setenv DESID_CHEM_CTRL_NML ${BLD}/CMAQ_Control_DESID_${MECH}.nml
  setenv DESID_CHEM_CTRL_NML ${BLD}/CMAQ_Control_DESID_${MECH}.nml
# CMAQ_Control_DESID_cb6r5hap_ae7_aq.nml AND CMAQ_Control_DESID_cb6r5hap_ae7_aq_NonVolPOA.nml ARE SAME IN BLD
...
# in /home/kappel/CMAQ_Code/PROJECTS/CMAQ_v54_20220617/CCTM/scripts/run_cctm_2016_12US1.csh
# CMAQ_MASKS and OCEAN_1 are the same file
# $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US1.nc
# /OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US2.nc is m3wd 12us2 file

  #> Spatial Masks For Emissions Scaling
  setenv CMAQ_MASKS ${CMAQ_DATA}/surface/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US1.nc

  #> In-line sea spray emissions configuration
  setenv OCEAN_1 ${CMAQ_DATA}/surface/OCEAN_${MM}_L3m_MC_CHL_chlor_a_12US1.nc

  #> Determine Representative Emission Days
     #> In-line emissions configuration
        set refdir = ${CMAQ_DATA}/smk_dates
...
set epath  = ${CMAQ_DATA}/emis/smoke_out/2020ha2_cb6_20k/12US1/cmaq_cb6ae7
set epath2 = ${CMAQ_DATA}/emis/2020ha_cb6_20k/premerged/
set ecase = _2020ha_cb6_20k.ncf
set ecase2 = _2020ha2_cb6_20k.ncf
...
setenv GR_EMIS_$zsem $epath/$tsem/emis_mole_all_${dsem}_12US1_nobeis_norwc$ecase2

else if ( $tsem == rwc ) then
setenv GR_EMIS_$zsem $epath2/$tsem/emis_mole_${tsem}_${dsem}_12US1_cmaq_cb6ae7$ecase
...
# /work/ROMO/pm_naaqs_2023/smoke_out/2032gg_18j/12US2/cmaq_cb6ae7

set ptpath1 = $epath
set ptpath2 = ${CMAQ_DATA}/emis/smoke_out/2020ha_cb6_20k/12US1/cmaq_cb6ae7/

set pcase1 = _12US1_cmaq_cb6ae7_2020ha_cb6_20k.ncf
set scase1 = _12US1_2020ha_cb6_20k.ncf

#set pcase2 = _12US1_cmaq_cb6ae7_2018gg_18j.ncf
#set scase2 = _12US1_2018gg_18j.ncf

# sector list
# cmv_c1c2_12, cmv_c3_12, canmex_point, pt_oilgas, ptagfire, ptfire-rx, ptfire-wild, ptfire_othna, ptnonipm
# 9            10         8              2          7         4          5            6             1

# ptegu_summer ptegu_winter ptegu_wintershld = 3

# set season for ptegu based on the current month
#if ( $mon == 01 || $mon == 02 || $mon == 12 ) then
#    set temp = winter
#else if ( $mon == 03 || $mon == 04 || $mon == 10 || $mon == 11 ) then
#    set temp = wintershld
#else # summer
#    set temp = summer
#endif
...
8.canmex_point.$mwdss_N.T.PT_OTHER       \
...
if  ( $tsect == ptfire-rx || $tsect == ptfire-wild || $tsect == ptfire_othna || $tsect == ptagfire ) then
	setenv STK_EMIS_$zsect $ptpath2/$tsect/inln_mole_${tsect}_$dsect$pcase1
	setenv STK_GRPS_$zsect $ptpath2/$tsect/stack_groups_${tsect}_$dsect$scase1

# normal defaults
else
setenv STK_EMIS_$zsect $ptpath2/$tsect/inln_mole_${tsect}_$dsect$pcase1
setenv STK_GRPS_$zsect $ptpath2/$tsect/stack_groups_$tsect$scase1
...
setenv STK_EM_DTOVRD_$zsect   $rsect  # previous versions
setenv STK_EM_SYM_DATE_$zsect $rsect
  ...
  if ( $CTM_BIOGEMIS_MG == 'Y' ) then
    setenv MEGAN_SOILINP    $OUTDIR/CCTM_MSOILOUT_${RUNID}_${YESTERDAY}.nc
         ...
         setenv MEGAN_LDF na /work/MOD3DATA/2016_12US1/surface/megan3.2/LDF_CONUS.ncf
...
# setenv BIOG_SPRO  BC6E7 for emis gspro_biogenics_28apr2020_v10.txt

# beis for task 4.8 and 4.13:
# from /home/kappel/CMAQ_Code/PROJECTS/CMAQ_v54_20220617/CCTM/scripts/run_cctm_2016_12US1.csh
# /work/MOD3DATA/2016_12US1/surface window to 12US2:
# b3grd.smoke30_beis361.12US1.2011NLCD_FIA5.1_CDL_norm_v3.ncf
# BIOSEASON and BIOSW_YN are not in v5.4 scripts or in v5.4 code.
# come from Chris
# gspro_biogenics_28apr2020_v10.txt), the mechanism name is BC6E7 rather than B10C6AE7. 
# We shortened the name in our GSPRO because SMOKE has a 5 character limit. 
# Other than the mechanism name being shorter and some extra stuff we only use for SMOKE, 
# it is the same as the gspro_biogenics.txt file that EPA provided. 
# So you can either use EPA's GSPRO with mechanism B10C6AE7, or use our GSPRO with mechanism BC6E7, 
...
#
  ...
  if ( $CTM_BIOGEMIS_BE == 'Y' ) then
     set IN_BEISpath = /work/ROMO/hapcap/smoke_out/2020ha_cb6_20k/12US1/cmaq_cb6ae7/beis_inline/
     setenv GSPRO          ${BLD}/gspro_biogenics.txt # task 4.8 and 4.13
     setenv BEIS_NORM_EMIS {CMAQ_DATA}/surface/beis_norm_emis_12US1_2020ha_cb6_20k.ncf
#     setenv BEIS_NORM_EMIS $base0/ref/b3grd.smoke30_beis361.12US2.2011NLCD_FIA5.1_CDL_norm_v3.ncf
     setenv BEIS_SOILINP   $OUTDIR/CCTM_BSOILOUT_${RUNID}_${YESTERDAY}.nc
                             #> Biogenic NO soil input file; ignore if NEW_START = TRUE
# based on 
# /home/kappel/CMAQ_Code/PROJECTS/CMAQ_v54_20220617/CCTM/scripts/BLD_CCTM_v54_intel21.4_STAGE
# -rw-r--r--. 1 kappel mod3eval 10034 2022-06-21 14:58 gspro_biogenics.txt
#      B10C6AE7: CB6r[3,5] - ae7 based mechanism
     setenv BIOG_SPRO B10C6AE7 # in v5.4 cmaq code but not in sample scripts
  endif
...
##if WB_DUST == Y, we need /work/MOD3APP/ezv/2020_12US1/surface
...
# beld4 is indowed to 12us2 for task 4.8 and 4.13 from
# /home/kappel/CMAQ_Code/PROJECTS/CMAQ_v54_20220617/CCTM/scripts
# run_cctm_2016_12US1.csh
# beld4_camq12km_2011_4CMAQioapi.ncf

#> Bidiretional ammonia configuration
 if ( $CTM_ABFLUX == 'Y' ) then
#     setenv EPIC_PATH /asm/MOD3DATA/CMAQv53_TS/2020_12US
     setenv EPIC_PATH ${CMAQ_DATA}/festc1_4_dev/scenarios/CMAQ_Ready_Time_Series
     setenv E2C_SOIL ${EPIC_PATH}/${YYYY}r1_EPIC0509_12US1_soil.nc4
     setenv E2C_CHEM ${EPIC_PATH}/${YYYY}r1_EPIC0509_12US1_time${YYYYMMDD}.nc4
     setenv E2C_LU ${EPIC_PATH}/beld4_12US1_2011.nc4
  endif
...
#> Integrated Source Apportionment Method (ISAM) Options
 ...
 if ( $?CTM_ISAM ) then
    if ( $CTM_ISAM == 'Y' || $CTM_ISAM == 'T' ) then
       setenv SA_IOLIST ${WORKDIR}/isam_control_12US1.txt
...
#     /bin/rm -f ${OUTDIR}/CCTM_EMDIAG*${RUNID}_${YYYYMMDD}.nc
  ...
  setenv tr_matrix_nml ${CMAQ_DATA}/misc/Species_Table_TR_EQUATES_12US1.nml
