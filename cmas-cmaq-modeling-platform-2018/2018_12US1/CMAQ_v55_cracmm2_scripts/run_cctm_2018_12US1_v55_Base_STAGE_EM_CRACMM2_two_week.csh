...
#SBATCH -p 528_queue
#SBATCH -o /proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/CCTM/scripts/cmaq_12US1_cracmm2_two_week_%j.txt


# ============== CCTMv5.5.X STAGE EM CRACMM2 12US1 Run Script ================
# Usage: run.cctm >&! cctm_2018_12US1_CRACMM2.log &                                
#
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = STAGE_EM_2018_12US1_two_week  #> Application Name (e.g. Gridname)
...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}_cracmm2_stage
...
#> Set Working, Input, and Output Directories
 ...
 setenv INPDIR  ${CMAQ_DATA}/2018_12US1_two_week  #Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2017-12-22"     #> beginning date (July 1, 2018)
 set END_DATE   = "2018-01-02"     #> ending date    (July 2, 2018)
...
set BCpath    = $INPDIR/icbc/CMAQv54_2018_108NHEMI_CRACCM1_FROM_CB6R5M_STAGE_EMERSON/             #> boundary conditions input directory
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
	  ...
	  #setenv ICFILE CCTM_CGRID_v55_intel21.4_2018_12US1_20180701.nc
  ...
  #set BCFILE = BCON_CMAQv55_2018_12US1_CRACMM2_STAGE_FROM_108NHEMI_CB6R5M_STAGE_regrid_${YYYYMM}
