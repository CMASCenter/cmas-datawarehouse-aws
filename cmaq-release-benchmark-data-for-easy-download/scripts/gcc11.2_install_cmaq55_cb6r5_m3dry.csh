...
# Change CMAQ_HOME to a local directory
   #This will remove # from the start of line 102 or add it if it wasn't already there:
      sed -i '19s/^#/\n/; 19s/^[^\n]/#&/; 19s/^\n//' bldit_project.csh
      sed -i '20i set CMAQ_HOME = /proj/ie/proj/CMAS/CMAQ/CMAQv5.5/build/openmpi_gcc11.2' bldit_project.csh

set CMAQ_HOME = $BUILD/../openmpi_gcc11.2
mkdir $BUILD/../openmpi_gcc11.2
./bldit_project.csh
...
module load openmpi_4.0.1/gcc_11.2.0
 ...
 cd $BUILD/../openmpi_gcc11.2/
 sed -i '144i \       setenv BUILD /proj/ie/proj/CMAS/CMAQ/CMAQv5.5/build/LIBRARIES_gcc11.2' config_cmaq.csh
 sed -i '145i \       setenv OPENMPI /nas/longleaf/apps-dogwood/mpi/gcc_11.2.0/openmpi-4.0.1' config_cmaq.csh
...
cd $BUILD/../openmpi_gcc11.2/CCTM/scripts/
